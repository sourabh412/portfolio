...
import neuralnetwork from '../../assets/skills/neuralnetwork.png';
    ...
    return (
        <motion.div initial={initial_stat} animate={animate_stat}>
            ...
            <div className='mt-10'>
                ...
                as well as expertise in creating websites and mobile apps.
            ...
            <div id="iam_skill_imgs" className='flex justify-center items-center mt-10'>
                ...
                <img className='rounded-full p-2 bg-slate-800 mx-3' src={neuralnetwork} alt="Neural networks" height="40px" width="40px" />
            </div>
        </motion.div>
    )
}
